                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm">
                            ...
                            <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    class="label-top shadow-sm badge rounded-pill <?php echo e($item->status > 0 ? 'badge-danger' : 'badge-danger'); ?> ">
                                    <?php echo e($item->status > 0 ? 'Sudah Dipesan' : 'Belum Dipesan'); ?>
...
<?php echo $__env->make('template.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\sewagedung - Copy\resources\views/home.blade.php ENDPATH**/ ?>