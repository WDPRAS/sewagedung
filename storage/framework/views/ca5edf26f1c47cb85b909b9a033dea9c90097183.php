                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/ambildata/<?php echo e($row->id); ?>" class="btn btn-warning"><i
                                                class="fa fa-pen"></i></a>
                                        <a href="/delete/<?php echo e($row->id); ?>" class="btn btn-danger delete"
                                            data-id="<?php echo e($row->id); ?>"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('template.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\elyas\Basis Data\sewagedung 1- Copy\resources\views/admin/gedung.blade.php ENDPATH**/ ?>