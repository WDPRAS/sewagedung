...
<div class="wrapper">
    ...
    <form action="/registeruser" method="post" class="p-3 mt-3">
        ...
        <div class="form-field d-flex align-items-center"> <span class="far fa-user"></span>
            <input type="text" name="role" placeholder="role" required value="<?php echo e(old('role')); ?>">
        </div>
...
<?php /**PATH C:\laravel\sewagedung - Copy\resources\views/register.blade.php ENDPATH**/ ?>