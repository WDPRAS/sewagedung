                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <?php if($item->status == 1): ?>
                                    <a href="tambahboooking/<?php echo e($item->id); ?>" class="btn btn-primary" hidden>
                                        Pesan</a>
                                <?php elseif($item->status == 2): ?>
                                    <a href="tambahboooking/<?php echo e($item->id); ?>" class="btn btn-primary" hidden>
                                        Pesan</a>
...
<?php echo $__env->make('template.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\elyas\Basis Data\sewagedung 1- Copy\resources\views/home.blade.php ENDPATH**/ ?>