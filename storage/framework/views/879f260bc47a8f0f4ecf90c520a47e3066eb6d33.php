                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama_gedung"
                                                            value="<?php echo e($d->nama_gedung); ?>" class="form-control" readonly
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nama_penyewa"
                                                            value="<?php echo e($d->nama_penyewa); ?>" class="form-control" readonly
...
<?php echo $__env->make('template.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\elyas\Basis Data\sewagedung 1- Copy\resources\views/admin/editbooking.blade.php ENDPATH**/ ?>